        ...
        <div className="notion-like">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-8">
              <div className="notion-feature-card flex flex-col md:flex-row items-start gap-6 bg-white dark:bg-black">
              ...
              <div className="notion-feature-card flex flex-col md:flex-row items-start gap-6 bg-white dark:bg-black">
                <div className="flex-shrink-0 bg-gray-100 dark:bg-gray-800 p-3 rounded-lg">
                  <CalendarIcon className="w-6 h-6 text-gray-800 dark:text-gray-200" />
                </div>
                <div>
                  ...
                  <div className="mt-3">
                    ...
                    <span className="notion-tag ml-2">2時間</span>
                    <span className="notion-tag ml-2">ライブ配信</span>
                  </div>
                </div>
              </div>
              ...
              <div className="notion-feature-card flex flex-col md:flex-row items-start gap-6 bg-white dark:bg-black">
                ...
                <div>
                  ...
                  <div className="notion-callout mt-4">
                    <p className="text-sm">「ピタッとAI」は現在ベータ版ですが、コミュニティメンバーは無制限で利用できます。</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="notion-like">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="max-w-md mx-auto">
              <div className="notion-feature-card bg-white dark:bg-black">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 bg-black dark:bg-white rounded-full flex items-center justify-center">
                    <CheckIcon className="w-8 h-8 text-white dark:text-black" />
                  </div>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start">
                    <CheckIcon className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>AI情報の毎日配信</span>
                  </li>
                  <li className="flex items-start">
                    <CheckIcon className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-0.5" />
                ...
                <a href="#" className="notion-button w-full text-center flex items-center justify-center">
                  今すぐ参加する
                  <ArrowRightIcon className="ml-2 w-5 h-5" />
                </a>
              </div>
      ...
      <section className="notion-section bg-white dark:bg-black">
        <div className="notion-like">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="notion-feature-card mb-8 bg-white dark:bg-black">
              <h3 className="font-semibold text-lg mb-3 border-b border-gray-200 dark:border-gray-800 pb-3">お問い合わせ</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                カスタマーサービスへのお問い合わせは以下の連絡先までお願いします。
              </p>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-center">
                  <span className="font-medium mr-2">メールアドレス:</span>
                  <a href="mailto:info@ai-asobou.com" className="notion-link">info@ai-asobou.com</a>
                </li>
                <li className="flex items-center">
                  <span className="font-medium mr-2">お問い合わせフォーム:</span>
            ...
            <div className="notion-feature-card mb-8 bg-white dark:bg-black">
              <h3 className="font-semibold text-lg mb-3 border-b border-gray-200 dark:border-gray-800 pb-3">返金ポリシー</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                当コミュニティは以下の返金ポリシーを設けています：
              </p>
              <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                <li className="flex items-start">
                  <CheckIcon className="w-5 h-5 mr-2 text-gray-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="notion-feature-card bg-white dark:bg-black">
              <h3 className="font-semibold text-lg mb-3 border-b border-gray-200 dark:border-gray-800 pb-3">Stripeに関する情報</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
